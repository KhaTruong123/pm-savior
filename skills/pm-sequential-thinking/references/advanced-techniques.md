...
```
Thought 1/7: Initial proposal (surface)
...
Thought 7/7: Final proposal addressing all constraints
```

**Use for**: Complex initiatives where constraints emerge iteratively.
...
**Use for**: Churn diagnosis, root cause analysis, performance investigations.
...
Thought 8/9: Verify complete picture
Thought 9/9 [FINAL]: Integrated solution
```

**Use for**: Initiative design, program structuring, cross-team dependency problems.
